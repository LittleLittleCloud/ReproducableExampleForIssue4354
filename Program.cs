...
namespace ReproducableExample
{
    class Program
    {
        ...
        private static string ModelPath = @"C:\Users\xiaoyuz\Desktop\machinelearning-samples\datasets\Test\Model.zip";
        ...
        private static uint ExperimentTime = 30000;
        ...
        public static void Run()
        {
            ...
            ExperimentResult<RegressionMetrics> experimentResult = mlContext.Auto()
                .CreateRecommendationExperiment(new RecommendationExperimentSettings() { MaxExperimentTimeInSeconds = ExperimentTime, CacheBeforeTrainer = CacheBeforeTrainer.Auto })
